...
Все графические элементы должны ссылаться на конфиг изображений (images-config.js) и использовать svg-заглушки, пока не указан путь к реальной картинке.
---------------------------------------
Список файлов:
...
island-screen.html	Экран приключения на острове, собирается из слоёв и использует svg-заглушки из images-config.js. 
sea-screen.html	Экран плавания в открытом море, собирается из слоёв и использует svg-заглушки из images-config.js. 
js/app.js	Логика переключения экранов в index.html и рендер кнопок навигации. 
js/common.js	Общие утилиты отрисовки UI и изображений (svg fallback + позиционирование в %). 
js/game-config.js	Конфиги идеи игры, основных систем и баланса. 
js/images-config.js	Список всех изображений с габаритами и svg-заглушками. 
js/island-screen.js	Рендер сцены острова и анимация корабля/листьев. 
js/sea-screen.js	Рендер сцены открытого моря. 
styles/common.css	Общие стили и контейнер портретной ориентации. 
styles/screen.css	Общие стили слоёв и UI-элементов экранов. 
styles/island-screen.css	Стили и анимации экрана острова. 
styles/sea-screen.css	Стили экрана открытого моря. 
...
TODO:
1. Расширение острова
2.
3. Апгрейд костра в печку! (аля фростпанк)
4. добываемые Ресурсы  (деревья например)
5. Питомцы (лошадь)
6. монстрики [мб нашествие крыс?]

Баги:
- фоллбек картинки для html
- 
